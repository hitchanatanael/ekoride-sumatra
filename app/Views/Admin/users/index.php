                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 120px;">
                                        <div class="d-grid gap-2 d-md-block">
                                            <a href="<?= base_url() ?>users/edit/<?= $user['id']; ?>" class="btn btn-warning" data-toggle="tooltip" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <button class="btn btn-danger btn-delete" data-id="<?= $user['id']; ?>" data-toggle="tooltip" title="Hapus">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            ...
                            setTimeout(() => {
                                window.location.href = '<?= base_url('users/delete/') ?>' + mobilId;
                            }, 100);
                        });
