        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <a href="<?= base_url() ?>supir/tambah" class="btn btn-primary">
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <?php $no = 1; ?>
                            <?php foreach ($model as $supir) : ?>
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><?= $supir['nama']; ?></td>
                                    <td class="text-center" style="width: 200px;">
                                        <div class="d-grid gap-2 d-md-block">
                                            <a href="<?= base_url() ?>supir/edit/<?= $supir['id']; ?>" class="btn btn-warning" data-toggle="tooltip" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <button class="btn btn-danger btn-delete" data-id="<?= $supir['id']; ?>" data-toggle="tooltip" title="Hapus">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            ...
                            setTimeout(() => {
                                window.location.href = '<?= base_url('supir/delete/') ?>' + mobilId;
                            }, 100);
                        });
