                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <?php $no = 1; ?>
                            <?php foreach ($model as $mobil) : ?>
                                <tr>
                                    <td><?= $no++; ?></td>
                                    <td><?= $mobil['nama_mobil']; ?></td>
                                    <td><?= $mobil['plat']; ?></td>
                                    <td align="center"><img src="<?= base_url('uploads/' . $mobil['foto_mobil']) ?>" alt="" height="100px" width="150px"></style>
                                    </td>
                                    <td class="text-center" style="width: 120px;">
                                        <div class="d-grid gap-2 d-md-block">
                                            <a href="<?= base_url('mobil/edit/') ?><?= $mobil['id']; ?>" class="btn btn-warning" data-toggle="tooltip" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>

                                            <button class="btn btn-danger btn-delete" data-id="<?= $mobil['id']; ?>" data-toggle="tooltip" title="Hapus">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            ...
                            setTimeout(() => {
                                window.location.href = '<?= base_url('mobil/delete/') ?>' + mobilId;
                            }, 100);
                        });
